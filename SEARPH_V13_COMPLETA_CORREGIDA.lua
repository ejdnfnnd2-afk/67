-- ==========================================
-- UAI EASY LIBRARY V13 + SEARPH DEMO
-- Standalone version
-- ==========================================
...
Home:AddButton("Mostrar notificación", function()
    Window:AddNotification("SEARPH", "La interfaz está funcionando correctamente.", 3)
end)
...
Controls:AddSwitch("Modo Premium", function(value)
    ...
    Window:AddNotification("Premium", value and "Modo activado." or "Modo desactivado.", 2)
end)

Controls:AddTextBox("Escribí algo...", function(text)
    print("Texto recibido:", text)
    Window:AddNotification("Texto", "Ingresaste: " .. tostring(text), 2)
end)
...
local ModeDropdown = Controls:AddDropdown("Modo", function(value)
    ...
    Window:AddNotification("Modo", "Seleccionaste: " .. tostring(value), 2)
end)
...
Controls:AddKeybind("Mostrar ventana", function(key)
    print("Keybind ejecutado:", key)
    Window:Toggle()
end, {default = Enum.KeyCode.RightShift})

local Advanced = Controls:AddFolder("Advanced")
Advanced:AddLabel("Opciones avanzadas")

Advanced:AddButton("Test 1", function()
    Window:AddNotification("Advanced", "Test 1 ejecutado.", 2)
end)

Advanced:AddButton("Test 2", function()
    Window:AddNotification("Advanced", "Test 2 ejecutado.", 2)
end)
...
for _, theme in ipairs({"Midnight", "Dark", "Violet", "Emerald", "Crimson", "Amber"}) do
    Visual:AddButton("Tema " .. theme, function()
...
Info:AddButton("Test Notification", function()
    Window:AddNotification("V13", "Todos los componentes principales funcionan.", 4)
end)

Window:SetVisible(true)
Window:AddNotification("SEARPH", "Bienvenido a la demo completa de V13.", 4)
